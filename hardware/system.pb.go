...
func (x *System) GetStatus() _.SystemStatus {
...
type System_Status struct {
	// 设置系统状态
	Status _.SystemStatus `protobuf:"varint,1,opt,name=status,proto3,enum=triclass.system.status.SystemStatus,oneof"`
}
...
var file_hardware_system_proto_goTypes = []interface{}{
	...
	(_.SystemStatus)(0), // 1: triclass.system.status.SystemStatus
}

...
type Heartbeat struct {
	...
	// 厂商
	Manufacturer _.Manufacturer `protobuf:"varint,1,opt,name=manufacturer,proto3,enum=triclass.manufacturer.Manufacturer" json:"manufacturer,omitempty"`
	// 设备序列号
	Sn string `protobuf:"bytes,2,opt,name=sn,proto3" json:"sn,omitempty"`
	// 设备状态
	Status _.SystemStatus `protobuf:"varint,3,opt,name=status,proto3,enum=triclass.system.status.SystemStatus" json:"status,omitempty"`
}
...
func (x *Heartbeat) GetManufacturer() _.Manufacturer {
	if x != nil {
		return x.Manufacturer
	}
	return _.Manufacturer_UNKNOWN
}
...
func (x *Heartbeat) GetStatus() _.SystemStatus {
	if x != nil {
		return x.Status
	}
	return _.SystemStatus_ON
}
...
var file_dm_heartbeat_proto_rawDesc = []byte{
	...
	,
...
var file_dm_heartbeat_proto_goTypes = []interface{}{
	...
	(_.Manufacturer)(0), // 1: triclass.manufacturer.Manufacturer
	(_.SystemStatus)(0), // 2: triclass.system.status.SystemStatus
}
